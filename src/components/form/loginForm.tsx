...
export function LoginForm() {
  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit}>
      ...
      <button type="submit" className="w-full text-white bg-yellow-primary hover:bg-slate-300 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Entrar</button>
